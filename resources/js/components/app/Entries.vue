        ...
        >
          ...
          >
            <div
              ...
              class="text-uppercase mb-1 mt-1"
            >
              &bull; {{ pendency }}
            </div>
          </app-badge>
        ...
        <td class="align-middle text-center text-uppercase">
          <div class="d-flex flex-column">
            <app-action-button
              ...
              classes="btn btn-sm btn-primary m-1"
            ...
            <app-action-button
              ...
              classes="btn btn-sm btn-warning m-1"
            ...
            <app-action-button
              ...
              classes="btn btn-sm btn-success m-1"
            ...
            <app-action-button
              ...
              classes="btn btn-sm btn-danger m-1"
