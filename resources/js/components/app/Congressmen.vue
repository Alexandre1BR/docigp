              ...
              <div class="row">
                <div class="col-12">
                  <h5 class="">
                    <div>
                      <span
                        ><i v-if="congressman.unread" class="fa fa-dot-circle text-danger"></i>
                        <i v-if="!congressman.unread" class="fa fa-circle text-gray-light"></i
                      ></span>
                  ...
                  >
                    <small class="text-primary" style="font-size: 0.6rem"
