<template>
    <span>
        <b-button v-if="can('audits:show')" class="btn btn-sm btn-micro btn-primary" @click="activityLog(row)"
...
<!--                                {{audit}}-->
                            ...
                            <td>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li v-for="(value, key) in audit.old_values" class="list-group-item">
                                        {{key}} => {{value}}
                                    </li>
                                </ul>
                            </td>
                            <td>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li v-for="(value, key) in audit.new_values" class="list-group-item">
                                        {{key}} => {{value}}
                                    </li>
                                </ul>
                            </td>
