<template>
  <div class="mb-4 mt-4">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="row">
                      ...
                      <div class="d-flex justify-content-end col-4 mr-0 pr-4">
                        <div>
                          <pulse-loader
                            margin="3px"
                            color="#0a008a"
          ...
          <div class="col-12 py-2">
            <div class="row">
              ...
              <div class="col-12" v-if="hasCheckboxes()">
                <div :class="'p-2 mb-2' + (dontCenterFilters ? '' : ' text-center')">
    ...
    <b-collapse :id="makeRandomId()" v-model="collapsed" class="mt-0">
      <div class="row cursor-pointer" :v-b-toggle="unCollapsed" @click="unCollapsed = !unCollapsed">
...
export default {
  ...
  methods: {
    ...
    makeCollapsedLabel() {
      return this.collapsedLabel ? this.collapsedLabel : 'nada selecionado'
    },
  },
