    ...
    <form name="formUsers" id="formUsers" @if($mode=='show' ) action="{{ route('users.update', ['id' => $user->id]) }}" @else action="{{ route('users.store')}}" @endIf method="POST">
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <div class="form-row col-md-12 pb-2">
                ...
                <div class="form-row col-md-12">
                    <div class="form-group col-md-5 col-sm-12 text-center">
                        <select multiple size="10" name="all-roles" id="all-roles" class="form-select col-lg-6 com-md-8 col-sm-8 ui-widget-content ui-corner-all">
                    ...
                    <div class="form-group col-md-2 col-sm-12 text-center pb-5">
                        <br>
                        <br>
                    ...
                    <div class="form-group col-md-5 col-sm-12 text-center">
                        <select multiple size="10" name="assigned-roles" id="assigned-roles" class="form-select col-lg-6 com-md-8 col-sm-8 ui-widget-content ui-corner-all">
